    ...
    <div>
      <div className='category-container'>
        ...
        <div className='flex justify-center mb-5'>
          {
            showMore ? (<button className='btn job-btn' onClick={() => setShowMore(!showMore)}>Show Less</button>) : (<button className='btn job-btn' onClick={() => setShowMore(!showMore)}>See All Jobs</button>)
          }
        </div>
      </div>
    </div>
